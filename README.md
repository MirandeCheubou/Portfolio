...
## 📂 Structure du Projet
```text
├── index.html           # Page d'entrée (Menu dynamique)
├── accueil.html         # Présentation personnelle & CV
├── apropos.html         # Expériences, Compétences & Objectifs IA
├── projet.html          # Portfolio de réalisations & Tableau E4/E5
├── formation.html       # Parcours académique & Certifications
├── contact.html         # Hub de contact interactif
├── styles.css           # Fichier de style global (Variables :root)
└── script.js            # Logique du curseur et des interactions
